...
const ItemForm = ({ item, onSuccess }) => {
    ...
    const [pagibig_id_number, setPagibig_id_number] = useState('');
    ...
    useEffect(() => {
        if (item) {
            ...
            setPagibig_id_number(item.pagibig_id_number);
            setTin_number(item.tin_number);
        }
    }, [item]);
    ...
    const handleSubmit = async (event) => {
        ...
        const data = {
            ...
            sss_number, pagibig_id_number, tin_number
        };
        try {
            if (item) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <input type='text' value={pagibig_id_number} onChange={(e) => setPagibig_id_number(e.target.value)} />
            </div>
            <div>
                <label>TIN Number</label>
                <input type='text' value={tin_number} onChange={(e) => setTin_number(e.target.value)} />
            </div>
